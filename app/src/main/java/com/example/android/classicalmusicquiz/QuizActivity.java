...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        if (playWhenReady &&(playbackState == ExoPlayer.STATE_READY)) Log.d(TAG, "Player is playing");
        else if (playbackState == ExoPlayer.STATE_READY) Log.d(TAG, "Player is on pause");
        else Log.d(TAG, "Player is ended");
    }
