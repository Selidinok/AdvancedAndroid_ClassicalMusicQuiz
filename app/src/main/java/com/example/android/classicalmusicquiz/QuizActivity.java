...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void showNotification(PlaybackStateCompat state){
        ...
        if (state.getState() == PlaybackState.STATE_PLAYING){
            ...
            stringState = getString(R.string.pause);
        } else {
            icon = R.drawable.exo_controls_play;
            stringState = getString(R.string.play);
        }

        NotificationCompat.Action playPauseAction = new NotificationCompat.Action( icon , stringState,
                MediaButtonReceiver.buildMediaButtonPendingIntent(this,
                        PlaybackState.ACTION_PLAY_PAUSE));
        NotificationCompat.Action restartAction = new NotificationCompat.Action(R.drawable.exo_controls_previous, stringState,
                MediaButtonReceiver.buildMediaButtonPendingIntent(this,
